...
export async function POST(request) {
  try {
    ...
    if (type === 'popup') {
      ...
      // AI Tour Guide description — always in Bengali
      prompt = `বাংলাদেশের ${district} জেলার ${placeName} সম্পর্কে বিস্তারিত তথ্য দাও। ৩টি অনুচ্ছেদে লেখো: ১. ইতিহাস ও গুরুত্ব, ২. মূল আকর্ষণ, ৩. প্রবেশ মূল্য এবং দেখার সেরা সময়। মার্কডাউন ফরম্যাটে লেখো। শুধুমাত্র বাংলায় উত্তর দাও।`;
    }
