  ...
  try {
    ...
    if (type === 'popup') {
      prompt = language === 'bn'
        ...
        : `Give a 2-3 sentence brief description of ${placeName} in ${district}, Bangladesh. Mention what it is, why it's special, and a travel tip. Keep it concise.`;
    } else if (type === 'nearby') {
      prompt = language === 'bn'
        ? `বাংলাদেশের ${district} জেলার ${placeName} এর আশেপাশের ৫-১০ কিমি এর মধ্যে কী কী দর্শনীয় স্থান বা বিখ্যাত খাবারের দোকান আছে? ৫টি আইটেমের তালিকা দিন। প্রতিটি আইটেমের নাম এবং সংক্ষিপ্ত বিবরণ দিন।`
        : `What are the nearby attractions and famous food spots within 5-10km of ${placeName}, ${district} in Bangladesh? List 5 items with names and brief descriptions.`;
    } else {
      prompt = language === 'bn'
